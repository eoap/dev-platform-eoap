...
/workspace/.venv-eopf/bin/python -m uv pip install --no-cache-dir -e .

/workspace/.venv-eopf/bin/python -m ipykernel install --user --name dask-gateway --display-name "Python (EOPF Dask Application Package)"
